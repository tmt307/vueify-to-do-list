            ...
            <v-card>
                ...
                <v-list>
                    <v-list-item v-for="todo in todolist">
                        ...
                        <v-list-item-action>
                            <v-btn  @click="dialog = !dialog" color="gray accent-4" dark>
                                <v-icon 
                                 >mdi-pencil </v-icon> <span class="m-2">Edit</span>
                            </v-btn>
                        </v-list-item-action>

                        <v-list-item-action @click="deletetodo(todo)" >
                            <v-btn color="red accent-4" dark>
                        ...
                        <v-card-actions>
                            <div class="flex-grow-1">
                                <form @submit.prevent="todoformaddmethod">
                                    ...
                                    <v-btn color="primary" name="button" type="submit">add</v-btn>
